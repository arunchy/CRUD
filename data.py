...
var=StringVar()
delete=StringVar()
Label(root,text="FirstName").grid(row=0,column=0)
Label(root,text="LastName").grid(row=1,column=0)
...
Radiobutton(root,value="Male",text="Male",variable=var).grid(row=7,column=0)
Radiobutton(root,value="Female",text="Female",variable=var).grid(row=8,column=0)
E1=Entry(root,textvariable=e1).grid(row=0,column=1)
E2=Entry(root,textvariable=e2).grid(row=1,column=1)
E3=Entry(root,textvariable=e3).grid(row=2,column=1)
E4=Entry(root,textvariable=e4).grid(row=3,column=1)
E5=Entry(root,textvariable=e5).grid(row=4,column=1)
E6=Entry(root,textvariable=e6).grid(row=5,column=1)
E7=Entry(root,textvariable=delete).grid(row=13,column=0)
...
def update_data():
       ...
       conn5.commit()
       conn5.close()
Button(root,text="Create Table",command=create_table,width=50).grid(row=9,column=1)
Button(root,text="Add Data",command=Add_data,width=50).grid(row=10,column=1)
Button(root,text="show record",width=50,command=show_record).grid(row=11,column=1)
Button(root,text="Update Record",width=50,command=update_data).grid(row=12,column=1)
Button(root,text="Delete Record",width=50,command=delete_record).grid(row=13,column=1)
root.mainloop()
